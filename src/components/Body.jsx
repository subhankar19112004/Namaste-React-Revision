...
const Body = () => {
  ...
  const fetchData = async () => {
    const data = await fetch(
      "https://corsproxy.io/?https://www.swiggy.com/dapi/restaurants/list/v5?lat=12.9276773&lng=77.6212965&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING",
    );
